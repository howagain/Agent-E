...
from ae.core.skills.compose_email import compose_email
...
class BrowserNavAgent:
    ...
    def __register_skills(self):
        ...
        self.agent.register_for_llm(description=LLM_PROMPTS["COMPOSE_EMAIL_PROMPT"])(compose_email)
        self.browser_nav_executor.register_for_execution()(compose_email)
